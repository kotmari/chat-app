...
const AuthHeroPanel = () => {
  return (
    <section className={heroPanelClassName}>
      <AuthHeroPattern />
      <div className="relative z-1 flex flex-1 flex-col px-6 pb-6 pt-8 md:px-8 md:pt-10">
        <div className="text-center md:text-left">
          ...
          <p
            className="mx-auto mt-2.5 max-w-88 text-pretty font-mono text-[11px] font-medium leading-relaxed tracking-wide text-zinc-600 dark:text-[#98989D] md:mx-0 md:max-w-none"
          >
